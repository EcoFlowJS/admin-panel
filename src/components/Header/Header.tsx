...
import ChangePasswordModal from "../Modals/ChangePasswordModal/ChangePasswordModal.component";
import { changePWDModal } from "../../store/modals.store";

export default function Header() {
  const status = useAtomValue(initStatus);
  const changePWDOpen = useAtomValue(changePWDModal);
  ...
  return (
    <>
      ...
      {changePWDOpen ? <ChangePasswordModal /> : <></>}
    </>
  );
}
